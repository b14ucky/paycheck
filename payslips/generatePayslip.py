...
class PayslipData:
    ...
    grossPay: float
    pensionContributionEmployee: float
    disabilityContributionEmployee: float
    sicknessContributionEmployee: float
    socialContributionsEmployee: float
    healthInsuranceBase: float
    healthInsuranceContribution: float
    ppkContributionEmployee: float
    costsOfGettingIncome: int
    taxableIncome: float
    taxRate: int
    taxReductionAmount: int
    incomeTax: float
    netPay: float
    # employer related data
    pensionContributionEmployer: float
    disabilityContributionEmployer: float
    accidentContributionEmployer: float
    laborFundContributionEmployer: float
    FGSPcontributionEmployer: float
    ppkContributionEmployer: float
    employerCosts: float
...
class PayslipGenerator:
    ...
    def calculatePayslip(hoursWorked: float, hourlyWage: float, costsOfGettingIncome: int, hasPPK: bool = False, taxReductionAmount: int = 300):
        ...
        payslipData = PayslipData(
            ...
            taxRate=taxRate * 100, # convert to percentage value
